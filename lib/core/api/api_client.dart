...
import 'package:yunu_lk_flutter/core/api/auth_interceptor.dart';
...
class ApiClient {
  ...
  ApiClient({required ApiConfig config})
      : _dio = Dio(BaseOptions(baseUrl: config.baseUrl, headers: {
    ...
    _dio.interceptors.add(InterceptorsWrapper(
      ...
      onError: (DioException error, ErrorInterceptorHandler handler) {
        _logger.e("ERROR: ${error.message}",
            error: error.message, stackTrace: error.stackTrace);

...
abstract class $VendorCopyWith<$Res> {
  ...
  @useResult
  $Res call({String createdDate, int id, String name});
}
...
class _$VendorImpl implements _Vendor {
  ...
  @override
  String toString() {
    return 'Vendor(createdDate: $createdDate, id: $id, name: $name)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, createdDate, id, name);
